        ...
        <div className="container custom-container">
            ...
            <div className="row">
                <div className="col-md-4">
                    <img alt="Profile Photo" width="400" src="/images/profilephoto.jpeg" className='round-img'/>
                </div>
                <div className="col-md-7 mt-4">
                    <div className="row text-start titulo-ter">
                        <p>Henrique Mateus</p>
                    </div>
                    <div className="row text-start color-blue">
